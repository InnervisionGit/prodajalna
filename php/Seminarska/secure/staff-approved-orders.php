    ...
    <body>
        ...
        <div id="content">
            <center><table id="tabela">
                ...
                <?php 
                    $query = $DBH->prepare("SELECT * FROM `Order` o, Customer c WHERE Order_state = 'Approved' AND o.Customer_ID = c.Customer_ID ORDER BY o.Order_approvalDate DESC;");
                    $query->execute();
                    $rows = $query->fetchAll();
                    $num_rows = count($rows);
                ...
                <tr>
                    ...
                    <td><input type="button" value="Cancel" onclick="Cancel(<?php echo $index ;?>, this, <?php echo "$idorders[$index]";?>)"></td>
