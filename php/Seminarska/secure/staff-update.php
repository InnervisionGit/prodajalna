        ...
        if(isset($getPass) && isset($getRetypePass))
        {
            if($getPass === $getRetypePass) 
            {
                ...
                Header("Location: ./staff-home.php");
                    ...
                    $error = "Error. Failed to update the account.";
                  }
            }
            else {
...
<body>
    <div id="header">     
        <div id="header-navbar">
            <ul>
                <?php if(isset($_SESSION["usertype"]) && $_SESSION["usertype"] == "Staff") 
                {?>
    ...
    <div id="content"><center><b>Enter information you wish to update.</b></center><br>
